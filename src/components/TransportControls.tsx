...
/** Queue mode · randomize · auto-continue. Owns its own popover anchor ref —
 *  each bar mounts its own instance, so neither host has to hold one. */
export function QueueModeGroup({
  queueMode, onToggleQueueMode, onRandomize, queueLength,
